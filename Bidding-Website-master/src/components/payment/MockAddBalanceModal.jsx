...
const MockAddBalanceModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const fetchPaymentMethods = async () => {
    try {
      const response = await mockPaymentService.getPaymentMethods();
      setPaymentMethods(response.paymentMethods || []);
    } catch (error) {
      dispatch(showError('Failed to load payment methods'));
    }
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
        ...
        cardDetails: selectedMethod === 'DEMO_CARD' ? cardDetails : null
      });

      const response = await mockPaymentService.addBalance(
        parseFloat(amount),
        selectedMethod,
      ...
      setStep(5);
      dispatch(showSuccess(`Successfully added ${parseFloat(amount).toLocaleString()} ETB to your account`));
      ...
      dispatch(showError(error.message || 'Payment failed. Please try again.'));
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b">
          <h2 className="text-xl font-semibold text-gray-900">Add Balance (Demo)</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                ...
                <p className="text-sm text-blue-800">
                  ...
                  Use any demo card details for testing. You start with 1000 ETB demo balance.
                </p>
              </div>
          ...
          {step === 3 && (
            <div className="space-y-4">
              ...
              {selectedMethod === 'DEMO_CARD' && (
                <div className="space-y-4">
                  <h3 className="text-lg font-medium text-gray-900">Card Details (Demo)</h3>
                  
                  <div className="bg-yellow-50 p-3 rounded border border-yellow-200">
                    <p className="text-sm text-yellow-800">
                      <strong>Demo Cards:</strong> Use 4111111111111111 (Visa) or 5555555555554444 (Mastercard)
                    </p>
                  </div>
          ...
          {step === 4 && (
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Processing Demo Payment</h3>
              <p className="text-gray-600">Please wait while we process your demo payment...</p>
            </div>
          )}
          ...
          {step === 5 && (
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Demo Payment Successful!</h3>
              <p className="text-gray-600 mb-4">
                {formatAmount(parseFloat(amount))} has been added to your demo account.
              </p>
              <button
                onClick={onClose}
...
export default MockAddBalanceModal;